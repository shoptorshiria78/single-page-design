...
const SportsCardDark = () => {
    return (
        <div className="p-6 bg-[#292B32]">
            <h1 className="text-start font-bold text-lg border-b-2 w-14 border-blue-600 mb-6 text-white ">Sports</h1>
            ...
            <div className="flex flex-col md:flex-row  gap-2">
                ...
                <div className="bg-[#3B3E47] w-[190px] mx-auto  md:mx-0 p-2 shadow-lg">
                    ...
                    <div >
                        <p className="font-semibold text-white my-2 text-[14px] mt-3 text-center">Advertisement title</p>

                        <p className="text-xs text-white px-2 mt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    </div>
